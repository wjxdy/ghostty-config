...
- Main document: [`docs/CODEX_TERMINAL_CONFIG.md`](docs/CODEX_TERMINAL_CONFIG.md)
- Active Ghostty config snapshot: [`snapshots/ghostty/current/`](snapshots/ghostty/current/)
